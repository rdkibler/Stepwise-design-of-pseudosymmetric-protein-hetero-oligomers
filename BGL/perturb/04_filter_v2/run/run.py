...
constraints=[]
#print(input_pdb)
hbnet_pdb = input_pdb[:-13].split("/")[-1] + ".pdb"
hbnet_pdb_path = ""
hbnet_pdb_paths_file = "/home/rdkibler/projects/tiara_gen2/toroids/02_4_churro-9x_xtreme/02_generate_hbnets/output/hbnet_pdb_paths"
