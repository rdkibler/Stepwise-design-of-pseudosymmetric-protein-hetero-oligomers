...
chain_A_start = 58 #chain A motif will alwasy be correct
chain_A_end = 114
...
pymol.cmd.remove(f"chA and resi 84-228") #this is ok
pymol.cmd.remove(f"chB and resi 229-425")
...
pymol.cmd.select('C',f"n. c and chA and i. 83",enable=1)
pymol.cmd.select('N',"n. n and chB and i. 426",enable=1) #this always ok
